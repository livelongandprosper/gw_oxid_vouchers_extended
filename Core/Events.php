	...
	class Events {
		...
		public static function onActivate() {
			try {
				...
				self::add_db_field('oxvoucherseries', 'gw_voucher_mode', "TINYINT(1) UNSIGNED DEFAULT 0 NOT NULL COMMENT '1 = vouchers should be handled like discount when order is finished'");
